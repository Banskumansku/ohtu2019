...
public class Stepdefs {
    ...
    @When("nonexistent username {string} and password {string}")
    ...
    @When("an incorrect username {string} and password {string} and matching password confirmation are entered")
    ...
    public void aValidUsernameAndNonvalidPasswordAndMatchingPasswordConfirmationAreEntered(String username,
            String password) {
        registerWith(username, password);
    }
    ...
    public void userIsNotCreatedAndErrorShortUsernameIsReported(String string) {
        pageHasContent("username should have at least 3 characters");
    }

    @Then("user is not created and error short password {string} is reported")
    public void userIsNotCreatedAndErrorShortPasswordIsReported(String string) {
        pageHasContent("password should be at least 8 characters");
    }

    @Then("user is not created and error non matching passwords {string} is reported")
    public void userIsNotCreatedAndErrorNonMatchingPasswordsIsReported(String string) {
